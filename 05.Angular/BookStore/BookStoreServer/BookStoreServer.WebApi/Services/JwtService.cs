    ...
    public static class JwtService
    {
        public static string CreatToken(User user)
        {
            ...
            JwtSecurityToken handler = new(
                ...
                signingCredentials:new SigningCredentials(new SymmetricSecurityKey(Encoding.UTF8.GetBytes("My Secret Key my secret key fdskjfşksdjfşsdfdsadasjş")),SecurityAlgorithms.HmacSha256));
