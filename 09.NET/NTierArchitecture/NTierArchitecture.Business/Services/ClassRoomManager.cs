...
{
    public class ClassRoomManager(IClassRoomRepository classRoomRepository, IMapper mapper) : IClassRoomService
    {
        public string Create(CreateClassRoomDto request)
        {
            ...
            bool isClassNameExists =
            classRoomRepository.Any(p => p.Name == request.Name);
